(function ($) {
  ...
  $.fn.rating = function () {
    ...
    function _paintValue(ratingInput, value) {
      ...
      selectedStar.prevAll('i').removeClass('fa fa-star-o').addClass('fa fa-star');
      selectedStar.nextAll('i').removeClass('fa fa-star').addClass('fa fa-star-o');
    }

    // A private function to remove the selected rating
    function _clearValue(ratingInput) {
      var self = $(ratingInput);
      self.find('i').removeClass('fa fa-star').addClass('fa fa-star-o');
